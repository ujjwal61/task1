...
resource "aws_ebs_volume" "sandisk" {
  availability_zone = aws_instance.linux.availability_zone
  size              = 1
tags = {
    Name = "sandisk"
  }
...
resource "aws_volume_attachment" "ebs_attach" {
  device_name = "/dev/sdf"
  volume_id   = aws_ebs_volume.sandisk.id
...
provisioner "remote-exec"{
	  ...
	  "sudo systemctl enable httpd",
          ...
          "sudo git clone https://github.com/ujjwal61/task1.git /html_repo",
